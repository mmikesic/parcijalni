...
<div class="container">
    ...
    <div class="col-md-6">
        <select id="type" class="form-control @error('type') is-invalid @enderror" name="type" required>
            ...
            <option value="Administrator" {{ old('type') == 'Administrator' ? 'selected' : '' }}>{{ __('Administrator') }}</option>
            <option value="Team Leader" {{ old('type') == 'Team Leader' ? 'selected' : '' }}>{{ __('Team Leader') }}</option>
